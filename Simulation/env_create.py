...
# Set the joint motor control parameters
max_force = 100.0  # Adjust the maximum force according to your requirements
max_velocity = 100.0  # Adjust the maximum velocity according to your requirements
...
while True:
    ...
    p.setJointMotorControl2(robot_id, 0, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 1, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    # p.setJointMotorControl2(robot_id, 2, p.POSITION_CONTROL, targetPosition=0)
    # p.setJointMotorControl2(robot_id, 3, p.POSITION_CONTROL, targetPosition=0)
    p.setJointMotorControl2(robot_id, 4, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 5, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 6, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    # p.setJointMotorControl2(robot_id, 7, p.POSITION_CONTROL, targetPosition=0)
    # p.setJointMotorControl2(robot_id, 8, p.POSITION_CONTROL, targetPosition=0)
    p.setJointMotorControl2(robot_id, 9, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 10, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 11, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    # p.setJointMotorControl2(robot_id, 12, p.POSITION_CONTROL, targetPosition=0)
    # p.setJointMotorControl2(robot_id, 13, p.POSITION_CONTROL, targetPosition=0)
    p.setJointMotorControl2(robot_id, 14, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 15, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 16, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    # p.setJointMotorControl2(robot_id, 17, p.POSITION_CONTROL, targetPosition=0)
    # p.setJointMotorControl2(robot_id, 18, p.POSITION_CONTROL, targetPosition=0)
    p.setJointMotorControl2(robot_id, 19, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 20, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 21, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    # p.setJointMotorControl2(robot_id, 22, p.POSITION_CONTROL, targetPosition=0)
    # p.setJointMotorControl2(robot_id, 23, p.POSITION_CONTROL, targetPosition=0)
    p.setJointMotorControl2(robot_id, 24, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 25, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 26, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    # p.setJointMotorControl2(robot_id, 27, p.POSITION_CONTROL, targetPosition=0)
    # p.setJointMotorControl2(robot_id, 28, p.POSITION_CONTROL, targetPosition=0)
    p.setJointMotorControl2(robot_id, 29, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    p.setJointMotorControl2(robot_id, 30, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)

    check += 1
    if check % 50 == 0:
        # Down:
        p.setJointMotorControl2(robot_id, 3, p.POSITION_CONTROL, targetPosition=-0.5, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 13, p.POSITION_CONTROL, targetPosition=-0.5, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 23, p.POSITION_CONTROL, targetPosition=-0.5, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 8, p.POSITION_CONTROL, targetPosition=-0.5, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 18, p.POSITION_CONTROL, targetPosition=-0.5, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 28, p.POSITION_CONTROL, targetPosition=-0.5, force=max_force, maxVelocity=max_velocity)
    ...
    if 50 > check % 200 > 0:
        ...
        # MOVE:
        p.setJointMotorControl2(robot_id, 7, p.POSITION_CONTROL, targetPosition=-0.5, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 17, p.POSITION_CONTROL, targetPosition=0.5, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 27, p.POSITION_CONTROL, targetPosition=0.5, force=max_force, maxVelocity=max_velocity)

        p.setJointMotorControl2(robot_id, 2, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 12, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 22, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
    ...
    if 150 > check % 200 > 100:
        ...
        # MOVE:
        p.setJointMotorControl2(robot_id, 2, p.POSITION_CONTROL, targetPosition=-0.5, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 12, p.POSITION_CONTROL, targetPosition=-0.5, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 22, p.POSITION_CONTROL, targetPosition=0.5, force=max_force, maxVelocity=max_velocity)

        p.setJointMotorControl2(robot_id, 7, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 17, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
        p.setJointMotorControl2(robot_id, 27, p.POSITION_CONTROL, targetPosition=0, force=max_force, maxVelocity=max_velocity)
